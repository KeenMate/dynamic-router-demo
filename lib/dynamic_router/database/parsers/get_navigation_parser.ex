...
defmodule DynamicRouter.Database.Parsers.GetNavigationParser do
  @moduledoc """
  ...
  @spec parse_get_navigation_result({:ok, Postgrex.Result.t()} | {:error, any()}) ::
          {:ok,
           [
             DynamicRouter.Database.Models.GetNavigationItem.t()
           ]}
          | {:error, any()}
  ...
  def parse_get_navigation_result_row([
    ...
    {
      :ok,
      %DynamicRouter.Database.Models.GetNavigationItem{
        level: level,
