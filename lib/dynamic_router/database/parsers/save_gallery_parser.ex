...
defmodule DynamicRouter.Database.Parsers.SaveGalleryParser do
  @moduledoc """
  ...
  @spec parse_save_gallery_result({:ok, Postgrex.Result.t()} | {:error, any()}) ::
          {:ok,
           [
             DynamicRouter.Database.Models.SaveGalleryItem.t()
           ]}
          | {:error, any()}
  ...
  def parse_save_gallery_result_row([gallery_id, code, title_cs, title_en]) do
    {
      :ok,
      %DynamicRouter.Database.Models.SaveGalleryItem{
