...
defmodule DynamicRouter.Database.Parsers.GetGalleryPhotosParser do
  @moduledoc """
  ...
  @spec parse_get_gallery_photos_result({:ok, Postgrex.Result.t()} | {:error, any()}) ::
          {:ok,
           [
             DynamicRouter.Database.Models.GetGalleryPhotosItem.t()
           ]}
          | {:error, any()}
  ...
  def parse_get_gallery_photos_result_row([photo_id, photo_code, width, height, file_size]) do
    {
      :ok,
      %DynamicRouter.Database.Models.GetGalleryPhotosItem{
        photo_id: photo_id,
