...
defmodule DynamicRouter.Database.Parsers.DeleteNavItemsParser do
  @moduledoc """
  ...
  @spec parse_delete_nav_items_result({:ok, Postgrex.Result.t()} | {:error, any()}) ::
          {:ok,
           [
             DynamicRouter.Database.Models.DeleteNavItemsItem.t()
           ]}
          | {:error, any()}
  ...
  def parse_delete_nav_items_result_row([
    ...
    {
      :ok,
      %DynamicRouter.Database.Models.DeleteNavItemsItem{
        created: created,
