...
defmodule DynamicRouter.Database.Parsers.GetTopPhotosParser do
  @moduledoc """
  ...
  @spec parse_get_top_photos_result({:ok, Postgrex.Result.t()} | {:error, any()}) ::
          {:ok,
           [
             DynamicRouter.Database.Models.GetTopPhotosItem.t()
           ]}
          | {:error, any()}
  ...
  def parse_get_top_photos_result_row([photo_id, code, width, height, file_size]) do
    {
      :ok,
      %DynamicRouter.Database.Models.GetTopPhotosItem{
        photo_id: photo_id,
        code: code,
        width: width,
        height: height,
